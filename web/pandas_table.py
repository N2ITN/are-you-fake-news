...
table = df[['time','city','region_name','ip','request']].head(50)
...
def run():
    with open('templates/data.html','w') as t:
        t.write('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/milligram/1.1.0/milligram.min.css">')
