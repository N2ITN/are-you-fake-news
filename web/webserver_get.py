...
class GetSite:
    ...
    def articles_gen(self):
        ...
        res1 = list(dummy.Pool(15).imap_unordered(self.API.scrape_api_endpoint, url_list[:self.limit]))
        sleep(1)
        res2 = list(dummy.Pool(15).imap_unordered(self.API.scrape_api_endpoint, url_list[:self.limit]))
        res = res1 + res2
